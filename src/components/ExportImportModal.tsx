...
const ExportImportModal: React.FC<ExportImportModalProps> = ({ isOpen, onClose, onExport, onImport }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="p-2">
        <h2 className="text-xl font-bold text-slate-100 mb-6 text-center">{t('exportImportTitle')}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-slate-800/50 p-6 rounded-lg">
                ...
                <div className="space-y-3">
                    <button
                        ...
                        className="w-full bg-cyan-600 text-white font-semibold px-4 py-2 rounded-lg hover:bg-cyan-500 transition-colors"
                    >
                        {t('exportAsJson')}
                    </button>
                     <button
                        onClick={() => onExport('csv')}
                        className="w-full bg-emerald-600 text-white font-semibold px-4 py-2 rounded-lg hover:bg-emerald-500 transition-colors"
                    >
                        {t('exportAsCsv')}
                    </button>
                </div>
            ...
            <div className="bg-slate-800/50 p-6 rounded-lg">
                ...
                <p className="text-sm text-slate-400 mb-4">{t('importDescription')}</p>
