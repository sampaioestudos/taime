...
export const BrainCircuitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 5a3 3 0 1 0-5.993.13a3 3 0 0 0 5.993-.13m5.993-.13a3 3 0 1 0-5.993.13a3 3 0 0 0 5.993-.13M6.007 19.13A3 3 0 1 0 .014 19a3 3 0 0 0 5.993.13m11.986-.13a3 3 0 1 0-5.993.13a3 3 0 0 0 5.993-.13"/>
        <path d="M12 12a3 3 0 1 0-5.993.13A3 3 0 0 0 12 12.13m5.993-.13a3 3 0 1 0-5.993.13a3 3 0 0 0 5.993-.13"/>
        <path d="M6 8v4m6-6v4m6 0v4m-6 2v4m-6-2v4"/>
    </svg>
);

export const LightBulbIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M9 18h6v-2a4 4 0 0 0-4-4V8a4 4 0 0 0-8 0v2h2m8 0h2a4 4 0 0 0 4-4V8a4 4 0 0 0-8 0"/>
        <path d="M12 18v4m-4-2h8"/>
    </svg>
);
