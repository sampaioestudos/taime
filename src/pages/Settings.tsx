...
const Input = (props: React.InputHTMLAttributes<HTMLInputElement>) => (
    <input {...props} className="w-full bg-gray-700 text-gray-200 border border-gray-600 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500" />
);

const baseButtonClasses = "px-5 py-2 text-sm font-semibold rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 transition-colors disabled:opacity-50 disabled:cursor-wait";
const primaryButtonClasses = `${baseButtonClasses} bg-cyan-600 text-white hover:bg-cyan-500 focus:ring-cyan-500`;
const secondaryButtonClasses = `${baseButtonClasses} bg-gray-600 text-white hover:bg-gray-500 focus:ring-gray-500`;
const destructiveButtonClasses = `${baseButtonClasses} bg-red-600 text-white hover:bg-red-500 focus:ring-red-500`;
